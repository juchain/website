 ...
 */
@Controller
@RequestMapping("/video/bContent")
public class VideoBackController extends BaseController {
	@Autowired
    ContentService bContentService;

	@GetMapping()
	@RequiresPermissions("video:bContent:bContent")
	String bContent() {
		return "video/bContent/bContent";
	}
	...
	public PageUtils list(@RequestParam Map<String, Object> params) {
		...
		params.put("type", Constant.TYPE_VIDEO);
		params.put("isTop", 0);
		...
		params3.put("type", Constant.TYPE_VIDEO);
	...
	@GetMapping("/add")
	@RequiresPermissions("video:bContent:add")
	String add() {
		return "video/bContent/add";
	}

	@GetMapping("/edit/{cid}")
	@RequiresPermissions("video:bContent:edit")
	...
	public R save(ContentDO bContent) {
		...
		bContent.setType(Constant.TYPE_VIDEO);
...
//		}
	 ...
	 * 删除
	 */
	@RequiresPermissions("video:bContent:remove")
	@PostMapping("/remove")
	@ResponseBody
	 ...
	 * 删除
	 */
	@RequiresPermissions("video:bContent:batchRemove")
	 ...
	 * 置顶
	 */
	@RequiresPermissions("video:bContent:top")
	@PostMapping("/top")
	@ResponseBody
