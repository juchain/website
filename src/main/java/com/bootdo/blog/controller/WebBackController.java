 ...
 */
@Controller
@RequestMapping("/web/bContent")
public class WebBackController extends BaseController {
	@Autowired
    ContentService bContentService;

	@GetMapping()
	@RequiresPermissions("web:bContent:bContent")
	String bContent() {
		return "web/bContent/bContent";
	}
	...
	public PageUtils list(@RequestParam Map<String, Object> params) {
		params.put("isTop", 0);
		params.put("type", Constant.TYPE_WEB);
		...
		params3.put("type", Constant.TYPE_WEB);
	...
	@GetMapping("/add")
	@RequiresPermissions("web:bContent:add")
	String add() {
		return "web/bContent/add";
	}

	@GetMapping("/edit/{cid}")
	@RequiresPermissions("web:bContent:edit")
	...
	public R save(ContentDO bContent) {
		...
		bContent.setType(Constant.TYPE_WEB);
...
//		}
	 ...
	 * 删除
	 */
	@RequiresPermissions("web:bContent:remove")
	@PostMapping("/remove")
	@ResponseBody
	 ...
	 * 删除
	 */
	@RequiresPermissions("web:bContent:batchRemove")
	 ...
	 * 置顶
	 */
	@RequiresPermissions("web:bContent:top")
	@PostMapping("/top")
	@ResponseBody
