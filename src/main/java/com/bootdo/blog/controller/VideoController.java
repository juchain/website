...
@Controller
@Api(description = "视频新闻api", position = 1)
public class VideoController {
	...
	@GetMapping()
	String blog() {
		return "video/index/main";
	}

	@ResponseBody
	@GetMapping("/open/list")
	@ApiOperation(value = "视频新闻列表")
	...
	@GetMapping("/list")
	@ResponseBody
	@ApiOperation(value = "视频新闻")
	public List<ContentDO> newsList() {
		List<ContentDO> bContentList = bContentService.news(Constant.TYPE_VIDEO);
		return bContentList;
	}


	@GetMapping("/open/post/{cid}")
	@ApiOperation(value = "根据id获取单个视频新闻")
	@ResponseBody
