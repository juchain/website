package com.bootdo.system.video.on.demand.demo;
...
public class UploadVideoDemo {
    //账号AK信息请填写(必选)
    private static final String accessKeyId = "LTAIZVzt34519H5R";
    //账号AK信息请填写(必选)
    private  static final String accessKeySecret = "PhhStC9Uv6gIJIkOSb1MP0Rg44a8Gt";
