						...
						columns : [
								...
								},
								{
									...
									formatter : function(value, row, index) {
                                        ...
                                        var g = '<a class="btn btn-success btn-sm" href="#" title="置顶"  mce_href="#" onclick="top2(\''
                                            + row.cid
...
function preview(id) {
	window.open("/web/open/post/"+id+"#/");
	//window.location.href="/web/open/post/"+id;
}
